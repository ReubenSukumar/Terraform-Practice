...
resource "aws_instance" "Testing_Instance" {
  ...
  security_groups = [ "sg-0e15788c553321654" ]          # If Security Group is already created mention else remove this field
  subnet_id = "subnet-04bc3d5190e987321"                # Mention the created subnet else remove this field
